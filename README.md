...
To install the SDK with Edgematic Studio enabled, select the alternative
...
The variant is generated by `tools/prepare_s3_artifacts.sh` and also included
alongside the online metadata in offline bundle publications; Studio setup
